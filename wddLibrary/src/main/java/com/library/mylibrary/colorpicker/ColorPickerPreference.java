...
public class ColorPickerPreference extends Preference {
	...
	protected  com.library.mylibrary.colorpicker.ColorPickerView.WHEEL_TYPE wheelType;
	...
	private void initWith(Context context, AttributeSet attrs) {
		...
		try {
			...
			wheelType =  com.library.mylibrary.colorpicker.ColorPickerView.WHEEL_TYPE.indexOf(typedArray.getInt(R.styleable.ColorPickerPreference_wheelType, 0));
