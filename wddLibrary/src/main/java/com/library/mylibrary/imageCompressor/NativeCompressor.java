package com.library.mylibrary.imageCompressor;
...
public class NativeCompressor implements Handler.Callback {
  ...
  private NativeCompressor(Builder builder) {
  ...
  public static class Builder {
    ...
    private NativeCompressor build() {
      return new NativeCompressor(this);
    }
